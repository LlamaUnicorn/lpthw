...
central_corridor = Room("Central Corridor",
                        ...
                        it in the bridge, and blow the ship after getting into an escape pod.
...
laser_weapon_armory = Room("Laser Weapon Armory",
                           """
                            ...
                            the acadey. You tell the one Gothon joke you know:
                            Lbne zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr,
...
def load_room(name):
    ...
    Who gets to set name? Cat that expose a variable?
    """
